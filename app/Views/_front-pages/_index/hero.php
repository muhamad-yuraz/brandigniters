    ...
    <div class="row flex-lg-row-reverse align-items-center g-5 py-5 pb-0">
      ...
      <div class="col-lg-6">
        ...
        <div class="d-flex align-items-center mb-5">
          <img src="<?php echo base_url(); ?>public/assets/_imagens/main_logo/brandigniters_logo_only_gray.svg" class="img-fluid" height="30" style="filter: grayscale(1);">
          <span class="sub-text-bi-hero hnd-l">#excelência #inovação</span>
        </div>

        <h1 class="main-text-bi-hero mb-5 hnd-l">
          <span class="hnd-b">Temos tudo</span> que você precisa para
        ...
        <!-- Input Card -->
          <div class="input-card border">
            <div class="input-card-form">
              <label for="searchAppsForm" class="form-label visually-hidden">Subscreva-se a nossa newsletter..</label>
              <input type="text" class="form-control t20-px" id="searchAppsForm" placeholder="Subscreva-se a nossa newsletter.." aria-label="Search for apps">
            </div>
            <button type="button" class="btn btn-bi-red text-uppercase">
              Subscrever-me
