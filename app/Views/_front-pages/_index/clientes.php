  ...
  <div class="container col-xxl-8 px-4 py-5 pb-5 mb-5">
    <div class="row d-flex align-items-center g-5 py-5 pb-5">
      <div class="col-12 mb-2 pb-0">
        <p class="bi-red-color hnd-l mb-0">FAÇA PARTE DA FAMÍLIA</p>
      </div>
      <div class="col-12 col-xxl-4 mt-0 pt-0">
        <span class="h1 main-text-bi-hero mb-4 hnd-l mt-2">Os nossos <span class="hnd-b">clientes</span></span>
      </div>
      <div class="col-12 col-xxl-8 mt-0 pt-0">
        <hr class="bi-red-color bi-red-background" style="opacity: 1; border-top: 2px solid #CC1840;">
      </div>
      <div class="col-12">
